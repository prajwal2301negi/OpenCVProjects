...
while True:
    ...
    if qNo<qTotal:
        ...
        if hands:
            ...
            cursor = lmList[8] # tip of the index finger. Similarly 12 is the tip of middle finger.
            length, info, _ = detector.findDistance(lmList[8][:2], lmList[12][:2])
        # Using same Approach that when the dist between the two is less, the answer is clicked.
            if length < 60:
    ...
    # Draw Progress Bar
    #barValue = 150 # starting value
    barvalue = 150 + (950//qTotal)*qNo  # 950 is total width of bar ie 1100 - 150
