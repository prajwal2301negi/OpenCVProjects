...
myColorFinder = ColorFinder(False) # False -> No debug Mode
hsvVals = {'hmin': 8, 'smin': 96, 'vmin': 115, 'hmax': 14, 'smax': 255, 'vmax': 255}
# write True in COlorFinder and hsvVals = 'red to get hsv Value and run find
...
while True:
    ...
    if contours: # take biggest contour and it is in sorted order
    ...
    if posListX:
        ...
        for i, (posX, posY) in enumerate(zip(posListX, posListY)):
            pos = (posX, posY) # line between previous and current time
    ...
    # image to find location of ball using contors, the arc we get is based on this -> mask in place of imgContours.
